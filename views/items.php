			...
			<form class="frm_addequipment" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<select name="e_category" class="form-control" required>
						...
						<option>Jumper Wire</option>
						<option>Cable</option>
						<option>Multimeter</option>
						<option>DC Power Generator</option>
						<option>Signal Generator</option>
						<option>Microprocessor 8086</option>
						<option>IC</option>
						<option>Bread Board</option>
						<option>LED</option>
						<option>OP-Amp</option>
						<option>MCM24/EV</option>
						<option>MCM25/EV</option>
						<option>MCM31/EV</option>
						<option>Probes</option>
						<option>Optical Fiber Board</option>
					</select> 
				</div>
				<div class="form-group">
					<label>Brand</label>
