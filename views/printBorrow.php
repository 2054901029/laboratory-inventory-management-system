...
<body>
	<table style="width:100%" cellpadding="0" cellspacing="0">
		<tbody>
			<tr>
				<td><img src="logo.png" height="200px" width="200px" class="img-responsive" /></td>
				<td style="text-align:center; font-size:13pt; font-family:'Times New Roman'">
					<p style="margin:0;padding:0;">Laboratory Inventory Management System</p>
					<p style="margin:0;padding:0;font-weight:bold;">Bangladesh University of Professionals</p>
					<p style="margin:0;padding:0;">Mirpur Cantonment, Dhaka</p>
				</td>
				<td><img src="" class="img-responsive" style="visibility: hidden" /></td>
			</tr>
			<tr>
				<td></td>
